...
RSpec.describe Users::Identity::RegisterService do
  ...
  context 'when values are missing' do
    ...
    context 'when email is nil' do
      before do
        setup_identity_provider Code0::Identities::Identity.new(provider_id, 'identifier', 'username', nil,
                                                                'firstname', 'lastname')
      end
    ...
    context 'when username is missing' do
      ...
      before do
        setup_identity_provider Code0::Identities::Identity.new(provider_id, 'identifier', nil, email, 'firstname',
                                                                'lastname')
      end
  ...
  context 'when identity is already existing with same provider and identifier' do
    ...
    before do
      setup_identity_provider Code0::Identities::Identity.new(existing_identity.provider_id,
                                                              existing_identity.identifier,
                                                              'username',
                                                              generate(:email),
                                                              'firstname',
                                                              'lastname')
  ...
  context 'when email is a duplicate' do
    ...
    before do
      setup_identity_provider Code0::Identities::Identity.new(provider_id, 'identifier', 'username',
