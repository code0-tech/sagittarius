...
RSpec.describe Namespaces::Members::AssignRolesService do
  subject(:service_response) { described_class.new(create_authentication(current_user), member, roles).execute }
