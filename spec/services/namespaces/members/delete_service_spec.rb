...
RSpec.describe Namespaces::Members::DeleteService do
  subject(:service_response) { described_class.new(create_authentication(current_user), namespace_member).execute }
