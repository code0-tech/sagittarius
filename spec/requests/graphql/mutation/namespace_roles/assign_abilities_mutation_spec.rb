...
RSpec.describe 'namespaceRolesAssignAbilities Mutation' do
  ...
  let(:mutation) do
    <<~QUERY
      mutation($input: NamespaceRolesAssignAbilitiesInput!) {
        namespaceRolesAssignAbilities(input: $input) {
          #{error_query}
          abilities
        }
      }
  ...
  context 'when user has permission' do
    ...
    it 'assigns the given abilities to the role' do
      ...
      abilities = graphql_data_at(:namespace_roles_assign_abilities, :abilities)
  ...
  context 'when user does not have permission' do
    it 'returns an error' do
      ...
      expect(graphql_data_at(:namespace_roles_assign_abilities, :abilities)).to be_nil
      expect(
        graphql_data_at(:namespace_roles_assign_abilities, :errors)
