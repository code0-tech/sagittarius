  ...
  module Grpc
    module FlowTypes
      class UpdateService
        ...
        attr_reader :current_runtime, :flow_types, :runtime_module, :definition_source, :update_runtime_compatibility

        def initialize(current_runtime, flow_types, runtime_module:, definition_source: nil,
