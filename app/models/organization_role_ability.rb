...
class OrganizationRoleAbility < ApplicationRecord
  ...
  ABILITIES = {
    ...
    delete_organization_license: { db: 16, description: 'Allows to delete the license of the organization' }, # EE-specific
    update_organization_project: { db: 17, description: 'Allows to update the project of the organization' },
