...
class OrganizationRoleAbility < ApplicationRecord
  ...
  ABILITIES = {
    ...
    update_organization_project: { db: 15, description: 'Allows to update the project of the organization' },
    delete_organization_project: { db: 16, description: 'Allows to delete the project of the organization' },
