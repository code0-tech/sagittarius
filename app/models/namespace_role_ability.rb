...
class NamespaceRoleAbility < ApplicationRecord
  ABILITIES = {
    ...
    read_flow: { db: 24, description: 'Allows to read flows in the project' },
    create_flows: { db: 24, description: 'Allows to create flows in the project' },
    update_flows: { db: 25, description: 'Allows to update flows in the project' },
    delete_flows: { db: 26, description: 'Allows to delete flows in the project' },
