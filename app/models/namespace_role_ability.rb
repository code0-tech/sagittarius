...
class NamespaceRoleAbility < ApplicationRecord
  ABILITIES = {
    ...
    create_flows: { db: 24, description: 'Allows to create flows in the namespace' },
    update_flows: { db: 25, description: 'Allows to update flows in the namespace' },
    delete_flows: { db: 26, description: 'Allows to delete flows in the namespace' },
