...
class RuntimeUsageDailyAggregate < ApplicationRecord
  ...
  belongs_to :flow, inverse_of: :runtime_usage_daily_aggregates
  belongs_to :project, class_name: 'NamespaceProject', inverse_of: :runtime_usage_daily_aggregates
  belongs_to :namespace, inverse_of: :runtime_usage_daily_aggregates
