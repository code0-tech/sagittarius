...
CREATE SEQUENCE p_audit_events_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE p_audit_events_id_seq OWNED BY p_audit_events.id;

CREATE TABLE p_execution_node_results (
    id bigint NOT NULL,
...
CREATE SEQUENCE p_execution_node_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE p_execution_node_results_id_seq OWNED BY p_execution_node_results.id;

CREATE TABLE p_execution_parameter_results (
    id bigint NOT NULL,
...
CREATE SEQUENCE p_execution_parameter_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE p_execution_parameter_results_id_seq OWNED BY p_execution_parameter_results.id;

CREATE TABLE p_execution_results (
    id bigint NOT NULL,
    flow_id bigint NOT NULL,
...
CREATE SEQUENCE p_execution_results_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
CREATE VIEW postgres_detached_partitions AS
...
CREATE TABLE runtime_module_status_daily_uptimes (
    id bigint NOT NULL,
    runtime_module_status_id bigint CONSTRAINT runtime_module_status_daily_u_runtime_module_status_id_not_null NOT NULL,
    date date NOT NULL,
...
CREATE SEQUENCE runtime_module_status_daily_uptimes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE runtime_module_status_daily_uptimes_id_seq OWNED BY runtime_module_status_daily_uptimes.id;
...
CREATE TABLE runtime_status_daily_uptimes (
    id bigint NOT NULL,
...
CREATE SEQUENCE runtime_status_daily_uptimes_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE runtime_status_daily_uptimes_id_seq OWNED BY runtime_status_daily_uptimes.id;
...
ALTER TABLE ONLY p_audit_events ALTER COLUMN id SET DEFAULT nextval('p_audit_events_id_seq'::regclass);

ALTER TABLE ONLY p_execution_node_results ALTER COLUMN id SET DEFAULT nextval('p_execution_node_results_id_seq'::regclass);

ALTER TABLE ONLY p_execution_parameter_results ALTER COLUMN id SET DEFAULT nextval('p_execution_parameter_results_id_seq'::regclass);
...
ALTER TABLE ONLY runtime_module_status_daily_uptimes ALTER COLUMN id SET DEFAULT nextval('runtime_module_status_daily_uptimes_id_seq'::regclass);
...
ALTER TABLE ONLY runtime_status_daily_uptimes ALTER COLUMN id SET DEFAULT nextval('runtime_status_daily_uptimes_id_seq'::regclass);
...
ALTER TABLE ONLY p_execution_node_results
    ADD CONSTRAINT p_execution_node_results_pkey PRIMARY KEY (id, created_at);

ALTER TABLE ONLY p_execution_parameter_results
...
ALTER TABLE ONLY runtime_module_status_daily_uptimes
    ADD CONSTRAINT runtime_module_status_daily_uptimes_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY runtime_status_daily_uptimes
    ADD CONSTRAINT runtime_status_daily_uptimes_pkey PRIMARY KEY (id);
...
CREATE UNIQUE INDEX idx_runtime_module_status_daily_uptimes_on_status_id_date ON runtime_module_status_daily_uptimes USING btree (runtime_module_status_id, date);

CREATE UNIQUE INDEX idx_runtime_modules_on_runtime_id_identifier ON runtime_modules USING btree (runtime_id, identifier);

CREATE UNIQUE INDEX idx_runtime_status_daily_uptimes_on_status_id_date ON runtime_status_daily_uptimes USING btree (runtime_status_id, date);
...
ALTER TABLE ONLY runtime_status_daily_uptimes
    ADD CONSTRAINT fk_rails_2c7a10f384 FOREIGN KEY (runtime_status_id) REFERENCES runtime_statuses(id) ON DELETE CASCADE;
...
ALTER TABLE ONLY runtime_module_status_daily_uptimes
    ADD CONSTRAINT fk_rails_4c1431049b FOREIGN KEY (runtime_module_status_id) REFERENCES runtime_module_statuses(id) ON DELETE CASCADE;

ALTER TABLE ONLY runtime_function_definitions
    ADD CONSTRAINT fk_rails_5161ff47e6 FOREIGN KEY (runtime_id) REFERENCES runtimes(id) ON DELETE CASCADE;

ALTER TABLE p_execution_results
    ADD CONSTRAINT fk_rails_521c5925e7 FOREIGN KEY (flow_id) REFERENCES flows(id) ON DELETE CASCADE;
...
ALTER TABLE p_execution_node_results
    ADD CONSTRAINT fk_rails_7aca8c4942 FOREIGN KEY (function_definition_id) REFERENCES function_definitions(id) ON DELETE SET NULL;
...
ALTER TABLE p_execution_node_results
    ADD CONSTRAINT fk_rails_885be76a3a FOREIGN KEY (node_function_id) REFERENCES node_functions(id) ON DELETE SET NULL;
...
ALTER TABLE p_audit_events
    ADD CONSTRAINT fk_rails_9c5a4c4493 FOREIGN KEY (author_id) REFERENCES users(id) ON DELETE RESTRICT;
...
ALTER TABLE ONLY flows
    ADD CONSTRAINT fk_rails_d9ad50fe4b FOREIGN KEY (flow_type_id) REFERENCES flow_types(id) ON DELETE CASCADE;
