...
class CreateGoodJobs < Sagittarius::Database::Migration[1.0]
  def change
    create_table :good_jobs, id: :uuid do |t|
      ...
      t.datetime_with_timezone :performed_at
      ...
      t.datetime_with_timezone :cron_at

      t.uuid :batch_id
      t.uuid :batch_callback_id

      t.boolean :is_discrete # rubocop:disable Rails/ThreeStateBooleanColumn -- this is a migration from good_job gem
    ...
    add_index :good_jobs, %i[queue_name scheduled_at],
              where: '(finished_at IS NULL)',
    ...
    add_index :good_jobs, %i[cron_key cron_at],
              where: '(cron_key IS NOT NULL)',
              unique: true,
